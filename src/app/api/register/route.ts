    ...
    try {
      if (process.env.SMTP_USER && process.env.SMTP_PASS) {
        ...
        await transporter.sendMail({
          ...
          to: email,
          subject: "Bem-vindo ao Organize! Seu acesso inicial",
          html: `
            <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; max-width: 600px; margin: 0 auto;">
              <h1 style="color: #4F46E5;">Olá!</h1>
              <p>Seu pré-cadastro no sistema <strong>Organize</strong> foi realizado com sucesso.</p>
              <p>Para concluir seu cadastro e acessar o sistema pela primeira vez, utilize a senha temporária abaixo:</p>
              <div style="background-color: #f3f4f6; padding: 15px; border-radius: 8px; margin: 20px 0; text-align: center;">
                <h2 style="margin: 0; color: #1f2937; letter-spacing: 5px;">${tempPassword}</h2>
              </div>
              <p>Clique no link abaixo e entre com seu e-mail e essa senha temporária:</p>
              <br/>
